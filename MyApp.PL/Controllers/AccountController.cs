...
namespace MyApp.PL.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController() { Db = new OrderService(MyGenerator.Connection()); }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                if (model.Email == null && model.Password == null) { ViewBag.errorMsg = "All fields are empty..."; }
                else if (model.Email == null || model.Password == null) { ViewBag.errorMsg = "Some of a field is empty..."; }
                else { ViewBag.errorMsg = "This user dosn't exist.."; }
                return View(model);
            }

            ApplicationUser appUser = UserManager.FindByEmail(model.Email);
            SignInStatus result = await SignInManager.PasswordSignInAsync(appUser.UserName, model.Password, model.RememberMe, shouldLockout: false);
            switch (result)
            {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Write current user to our datatbase:
